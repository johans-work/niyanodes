...
Adding a layer adds work that must be worth it. Digitizing gave data perfect copies. Nodalizing gives data an identity and home, makes it extensible, interoperable, and malleable. If data turned everything into 0s and 1s, nodalizing turns everything into things that talk.
