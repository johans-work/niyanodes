...
Any time you have nodes that progressively lead to more nodes, you inevitably get a tree. Your file system is essentially a node tree, and so is the web. But in both cases, the user is confined to the abstractions of each system. Niya adds a layer that focuses on the abstractions themselves, allowing you to start there and work from there. Add what's necessary, and do what's possible. It's abstraction, abstracted. A computational canvas for everything. 
